...
/*   Updated: 2025/07/02 10:59:42 by ttanaka          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char					*extract_val_when_additional(char *s, char *key,
							t_env *env);
char					*_concatenate_key_val(char *key, char *val,
							bool have_quote);
...
void					setup_pipefd(t_pipefd *fd, t_tree_node *node,
							bool is_start);
...
int						prepare_pl_here_docs(t_tree_node *node_pipeline,
							t_env *env);
...
void					free_for_find_cdpath(char *s1, char *s2,
							char **splitted_data);
/*others*/
