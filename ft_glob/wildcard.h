...
t_wildcard_type				_judge_chr_type(char c, bool *in_squote,
								bool *in_dquote);
...
int							_create_is_wildcard(t_wildcard_type *type_array,
								t_matching_info *info, char *pattern);
char						*_pattern_section_splitter(char *pattern_start,
								size_t window_size, size_t len,
								t_wildcard_type *type_array_start);
int							_create_pattern_sections(t_wildcard_type *type_array,
								t_matching_info *info, char *pattern);
